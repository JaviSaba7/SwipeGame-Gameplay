...
public class Enemy14 : MonoBehaviour
{
    ...
    public GameObject alien14_mesh;
    ...
    void Update()
    {
        if (startEnemy == true)
        {
            ...
            if (counterToRun >= 20 && counterToRun <= 23)
            {
                ...
                alien14_mesh.GetComponent<Animator>().enabled = true;
        ...
        if (deadEnemy)
        {
            ...
            explosion.transform.position = alien14_mesh.transform.position;
            alien14_mesh.SetActive(false);
        }

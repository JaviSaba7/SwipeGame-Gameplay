...
public class Enemy13 : MonoBehaviour
{
    ...
    public GameObject alien13_mesh;
    ...
    void Update()
    {
        if (startEnemy == true)
        {
            ...
            if (counterToRun >= 20 && counterToRun <= 23)
            {
                ...
                alien13_mesh.GetComponent<Animator>().enabled = true;
        ...
        if (deadEnemy)
        {
            ...
            explosion.transform.position = alien13_mesh.transform.position;
            alien13_mesh.SetActive(false);
        }

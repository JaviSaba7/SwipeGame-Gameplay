...
public class Enemy15 : MonoBehaviour
{
    ...
    public GameObject alien15_mesh;
    ...
    void Update()
    {
        if (startEnemy == true)
        {
            ...
            if (counterToRun >= 40 && counterToRun <= 43)
            {
                ...
                alien15_mesh.GetComponent<Animator>().enabled = true;
        ...
        if (deadEnemy)
        {
            ...
            explosion.transform.position = alien15_mesh.transform.position;
            alien15_mesh.SetActive(false);
        }

    ...
    void Update()
    {
        if (startEnemy == true)
        {
            ...
            if (counterToRun >= 20 && counterToRun <= 23)
            {
                ...
                alien6_mesh.GetComponent<Animator>().enabled = true;
        ...
        if (deadEnemy)
        {
            ...
            explosion.transform.position = alien6_mesh.transform.position;
            alien6_mesh.SetActive(false);
        }
    }
